...
var _bintree = &bintree{nil, map[string]*bintree{
	"migration": &bintree{nil, map[string]*bintree{
		...
		"017_claim_owner.sql":                   &bintree{migration017_claim_ownerSql, map[string]*bintree{}},
		"018_cert_sync_index.sql":               &bintree{migration018_cert_sync_indexSql, map[string]*bintree{}},
		"019_raw_tx.sql":                        &bintree{migration019_raw_txSql, map[string]*bintree{}},
		"020_content_type.sql":                  &bintree{migration020_content_typeSql, map[string]*bintree{}},
		"021_claim_reference.sql":               &bintree{migration021_claim_referenceSql, map[string]*bintree{}},
		"022_align_claim_id.sql":                &bintree{migration022_align_claim_idSql, map[string]*bintree{}},
		"023_sdhash_index.sql":                  &bintree{migration023_sdhash_indexSql, map[string]*bintree{}},
		"024_claims_in_channel.sql":             &bintree{migration024_claims_in_channelSql, map[string]*bintree{}},
		"025_outputindices.sql":                 &bintree{migration025_outputindicesSql, map[string]*bintree{}},
