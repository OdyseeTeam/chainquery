...
func migration000_init_schemaSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migration/000_init_schema.sql", size: 14354, mode: os.FileMode(420), modTime: time.Unix(1523072076, 0)}
