...
func (o *ApplicationStatus) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(applicationStatusAllColumns, strmangle.SetIntersect(insert, update))
...
// Exists checks if the ApplicationStatus row exists.
func (o *ApplicationStatus) Exists(exec boil.Executor) (bool, error) {
	return ApplicationStatusExists(exec, o.ID)
}
