...
func (o *JobStatus) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(jobStatusAllColumns, strmangle.SetIntersect(insert, update))
...
// Exists checks if the JobStatus row exists.
func (o *JobStatus) Exists(exec boil.Executor) (bool, error) {
	return JobStatusExists(exec, o.JobName)
}
