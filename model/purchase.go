...
func (r *purchaseR) GetTransactionByHash() *Transaction {
	if r == nil {
		return nil
	}
	return r.TransactionByHash
}
...
func (purchaseL) LoadTransactionByHash(e boil.Executor, singular bool, maybePurchase interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		if !queries.IsNil(object.TransactionByHashID) {
			args[object.TransactionByHashID] = struct{}{}
		}
		...
		for _, obj := range slice {
			...
			if !queries.IsNil(obj.TransactionByHashID) {
				args[obj.TransactionByHashID] = struct{}{}
			}
...
func (o *Purchase) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(purchaseAllColumns, strmangle.SetIntersect(insert, update))
...
func (o *Purchase) Exists(exec boil.Executor) (bool, error) {
	return PurchaseExists(exec, o.ID)
}
