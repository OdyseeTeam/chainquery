...
func (r *claimR) GetTransactionHash() *Transaction {
	if r == nil {
		return nil
	}
...
func (r *claimR) GetListClaimClaimInLists() ClaimInListSlice {
	if r == nil {
		return nil
	}
	return r.ListClaimClaimInLists
}

func (r *claimR) GetClaimTags() ClaimTagSlice {
	if r == nil {
		return nil
	}
	return r.ClaimTags
...
func (claimL) LoadListClaimClaimInLists(e boil.Executor, singular bool, maybeClaim interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`claim_in_list.list_claim_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (claimL) LoadClaimTags(e boil.Executor, singular bool, maybeClaim interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`claim_tag`),
		qm.WhereIn(`claim_tag.claim_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Claim) Exists(exec boil.Executor) (bool, error) {
	return ClaimExists(exec, o.ID)
}
