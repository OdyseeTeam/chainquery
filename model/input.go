...
func (r *inputR) GetTransaction() *Transaction {
	if r == nil {
		return nil
	}
...
func (o *Input) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(inputAllColumns, strmangle.SetIntersect(insert, update))
...
func (o *Input) Exists(exec boil.Executor) (bool, error) {
	return InputExists(exec, o.ID)
}
