...
func (r *transactionR) GetBlockHash() *Block {
	if r == nil {
		return nil
	}
	return r.BlockHash
...
func (r *transactionR) GetTransactionHashClaims() ClaimSlice {
	if r == nil {
		return nil
	}
	return r.TransactionHashClaims
}

func (r *transactionR) GetInputs() InputSlice {
	if r == nil {
		return nil
	}
	return r.Inputs
...
func (r *transactionR) GetOutputs() OutputSlice {
	if r == nil {
		return nil
	}
	return r.Outputs
...
func (r *transactionR) GetTransactionByHashPurchases() PurchaseSlice {
	if r == nil {
		return nil
	}
	return r.TransactionByHashPurchases
}

func (r *transactionR) GetTransactionHashSupports() SupportSlice {
	if r == nil {
		return nil
	}
	return r.TransactionHashSupports
}

func (r *transactionR) GetTransactionAddresses() TransactionAddressSlice {
	if r == nil {
		return nil
	}
	return r.TransactionAddresses
}
...
func (transactionL) LoadBlockHash(e boil.Executor, singular bool, maybeTransaction interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		if !queries.IsNil(object.BlockHashID) {
			args[object.BlockHashID] = struct{}{}
		}
	...
	query := NewQuery(
		qm.From(`block`),
		qm.WhereIn(`block.hash in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (transactionL) LoadTransactionHashClaims(e boil.Executor, singular bool, maybeTransaction interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args[object.Hash] = struct{}{}
	} else {
		for _, obj := range slice {
			if obj.R == nil {
				obj.R = &transactionR{}
			}
			args[obj.Hash] = struct{}{}
		}
	}
	...
	query := NewQuery(
		qm.From(`claim`),
		qm.WhereIn(`claim.transaction_hash_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (transactionL) LoadInputs(e boil.Executor, singular bool, maybeTransaction interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`input`),
		qm.WhereIn(`input.transaction_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (transactionL) LoadOutputs(e boil.Executor, singular bool, maybeTransaction interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`output`),
		qm.WhereIn(`output.transaction_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (transactionL) LoadTransactionByHashPurchases(e boil.Executor, singular bool, maybeTransaction interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`purchase`),
		qm.WhereIn(`purchase.transaction_by_hash_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (transactionL) LoadTransactionHashSupports(e boil.Executor, singular bool, maybeTransaction interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`support`),
		qm.WhereIn(`support.transaction_hash_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (transactionL) LoadTransactionAddresses(e boil.Executor, singular bool, maybeTransaction interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`transaction_address.transaction_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
