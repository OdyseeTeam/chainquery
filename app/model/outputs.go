...
type Output struct {
	...
	Addresses          null.String `boil:"addresses" json:"addresses,omitempty" toml:"addresses" yaml:"addresses,omitempty"`
...
// OutputFilter allows you to filter on any columns by making them all pointers.
type OutputFilter struct {
	...
	Hash160            *null.String `boil:"hash160" json:"hash160,omitempty" toml:"hash160" yaml:"hash160,omitempty"`
	Addresses          *null.String `boil:"addresses" json:"addresses,omitempty" toml:"addresses" yaml:"addresses,omitempty"`
	IsSpent            *bool        `boil:"is_spent" json:"is_spent,omitempty" toml:"is_spent" yaml:"is_spent,omitempty"`
	SpentByInputID     *null.Uint64 `boil:"spent_by_input_id" json:"spent_by_input_id,omitempty" toml:"spent_by_input_id" yaml:"spent_by_input_id,omitempty"`
...
var (
	outputColumns               = []string{"id", "transaction_id", "value", "v_out", "type", "script_pub_key_asm", "script_pub_key_hex", "required_signatures", "hash160", "addresses", "is_spent", "spent_by_input_id", "created", "modified"}
	outputColumnsWithoutDefault = []string{"transaction_id", "value", "v_out", "type", "script_pub_key_asm", "script_pub_key_hex", "required_signatures", "hash160", "addresses", "spent_by_input_id", "created", "modified"}
	outputColumnsWithDefault    = []string{"id", "is_spent"}
	outputPrimaryKeyColumns     = []string{"id"}
	outputAutoIncrementColumn   = "id"
)
...
func (q OutputQuery) One() (*Output, error) {
	...
	if err != nil {
		...
		return nil, errors.Prefix("model: failed to execute a one query for outputs", err)
	}
...
func (q OutputQuery) All() (OutputSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Prefix("model: failed to assign all query results to Output slice", err)
	}
...
func (q OutputQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Prefix("model: failed to count outputs rows", err)
	}
...
func (q OutputQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Prefix("model: failed to check if outputs exists", err)
	}
...
func (outputL) LoadSpentByInput(e boil.Executor, singular bool, maybeOutput interface{}) error {
	...
	results, err := e.Query(query, args...)
	if err != nil {
		return errors.Prefix("failed to eager load Input", err)
	}
	defer results.Close()

	var resultSlice []*Input
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Prefix("failed to bind eager loaded slice Input", err)
	}
...
func FindOutput(exec boil.Executor, id uint64, selectCols ...string) (*Output, error) {
	...
	if err != nil {
		...
		return nil, errors.Prefix("model: unable to select from outputs", err)
	}
...
// FindOneOutput retrieves a single record using filters.
func FindOneOutput(exec boil.Executor, filters OutputFilter) (*Output, error) {
	obj := &Output{}

	err := OutputNewQuery(exec).
		Where(filters).
		Limit(1).
		Bind(obj)
...
// FindOneOutputG retrieves a single record using filters.
func FindOneOutputG(filters OutputFilter) (*Output, error) {
	return FindOneOutput(boil.GetDB(), filters)
}

// FindOneOutputOrInit retrieves a single record using filters, or initializes a new record if one is not found.
func FindOneOutputOrInit(exec boil.Executor, filters OutputFilter) (*Output, error) {
	outputObj, err := FindOneOutput(exec, filters)
	if err != nil {
		return nil, err
	}
	...
	if outputObj == nil {
		outputObj = &Output{}
		objR := reflect.ValueOf(outputObj).Elem()
...
// FindOneOutputOrInit retrieves a single record using filters, or initializes a new record if one is not found.
func FindOneOutputOrInitG(filters OutputFilter) (*Output, error) {
	return FindOneOutputOrInit(boil.GetDB(), filters)
}

// FindOneOutputOrInit retrieves a single record using filters, or initializes and inserts a new record if one is not found.
func FindOneOutputOrCreate(exec boil.Executor, filters OutputFilter) (*Output, error) {
	outputObj, err := FindOneOutputOrInit(exec, filters)
	if err != nil {
		return nil, err
	}
	if outputObj.IsNew() {
		err := outputObj.Insert(exec)
		if err != nil {
			return nil, err
		}
	}
...
// FindOneOutputOrInit retrieves a single record using filters, or initializes and inserts a new record if one is not found.
func FindOneOutputOrCreateG(filters OutputFilter) (*Output, error) {
	return FindOneOutputOrCreate(boil.GetDB(), filters)
}
...
func (o *Output) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.Err("model: no outputs provided for insertion")
	}
	...
	if err != nil {
		return errors.Prefix("model: unable to insert into outputs", err)
	}
	...
	if err != nil {
		return errors.Prefix("model: unable to populate default values for outputs", err)
	}
...
func (o *Output) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.Err("model: unable to update outputs, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Prefix("model: unable to update outputs row", err)
	}
...
func (q OutputQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Prefix("model: unable to update all for outputs", err)
	}
...
func (o OutputSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Prefix("model: unable to update all in output slice", err)
	}
...
func (o *Output) Upsert(exec boil.Executor, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.Err("model: no outputs provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.Err("model: unable to upsert outputs, could not build update column list")
		}

		cache.query = queries.BuildUpsertQueryMySQL(dialect, "outputs", update, insert, outputAutoIncrementColumn)
	...
	if err != nil {
		return errors.Prefix("model: unable to upsert for outputs", err)
	}
...
func (o *Output) DeleteG() error {
	if o == nil {
		return errors.Err("model: no Output provided for deletion")
	}
...
func (o *Output) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.Err("model: no Output provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Prefix("model: unable to delete from outputs", err)
	}
...
func (q OutputQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.Err("model: no OutputQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Prefix("model: unable to delete all from outputs", err)
	}
...
func (o OutputSlice) DeleteAllG() error {
	if o == nil {
		return errors.Err("model: no Output slice provided for delete all")
	}
...
func (o OutputSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Prefix("model: unable to delete all from output slice", err)
	}
...
func (o *Output) ReloadG() error {
	if o == nil {
		return errors.Err("model: no Output provided for reload")
	}
...
func (o *OutputSlice) ReloadAllG() error {
	if o == nil {
		return errors.Err("model: empty OutputSlice provided for reload all")
	}
...
func (o *OutputSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&outputs)
	if err != nil {
		return errors.Prefix("model: unable to reload all in OutputSlice", err)
	}
...
func OutputExists(exec boil.Executor, id uint64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Prefix("model: unable to check if outputs exists", err)
	}
...
func (o *Output) IsNew() bool {
	r := reflect.ValueOf(o).Elem()
	for i := 0; i < r.NumField(); i++ {
		column := r.Type().Field(i).Tag.Get("boil")
		for _, pkColumn := range outputPrimaryKeyColumns {
			if column == pkColumn {
				field := r.Field(i)
...
func (o *Output) Save(exec boil.Executor, whitelist ...string) error {
	if o.IsNew() {
...
func (o *Output) SaveG(whitelist ...string) error {
	if o.IsNew() {
...
// OutputNewQuery filters query results
func OutputNewQuery(exec boil.Executor) *OutputQuery {
	return &OutputQuery{NewQuery(exec, qm.Select("*"), qm.From("`outputs`"))}
}

// OutputNewQuery filters query results
func OutputNewQueryG() *OutputQuery {
	return OutputNewQuery(boil.GetDB())
}

// Where filters query results
func (q *OutputQuery) Where(filters OutputFilter) *OutputQuery {
	r := reflect.ValueOf(filters)
	for i := 0; i < r.NumField(); i++ {
		f := r.Field(i)
		if f.Elem().IsValid() {
...
func (q *OutputQuery) Limit(limit int) *OutputQuery {
	queries.SetLimit(q.Query, limit)
	return q
}

// Merge combines two Outputs into one. The primary record will be kept, and the secondary will be deleted.
func MergeOutputs(exec boil.Executor, primaryID uint64, secondaryID uint64) (err error) {
	...
	primary, err := FindOutput(tx, primaryID)
	if err != nil {
		return errors.Err(err)
	} else if primary == nil {
		return errors.Err("primary Output not found")
	}

	secondary, err := FindOutput(tx, secondaryID)
	if err != nil {
		return errors.Err(err)
	} else if secondary == nil {
		return errors.Err("secondary Output not found")
	}

	foreignKeys := []foreignKey{
		{foreignTable: "outputs_addresses", foreignColumn: "output_id"},
	}
...
// Merge combines two Outputs into one. The primary record will be kept, and the secondary will be deleted.
func MergeOutputsG(primaryID uint64, secondaryID uint64) error {
	return MergeOutputs(boil.GetDB(), primaryID, secondaryID)
}
